...
namespace HomeERP.Migrations
{
    ...
    [Migration("20250607102338_add collections on initialize")]
    partial class addcollectionsoninitialize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeERP.Domain.Product.Models.ProductCollection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator().HasValue("ProductCollection");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("HomeERP.Domain.Product.Models.ProductInCollection", b =>
                {
            ...
            modelBuilder.Entity("HomeERP.Domain.Product.Models.Inventory", b =>
                {
            ...
            modelBuilder.Entity("HomeERP.Domain.Product.Models.ProductBundle", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ProductBundle");
                });

            modelBuilder.Entity("HomeERP.Domain.Product.Models.ShoppingList", b =>
                {
                    b.HasBaseType("HomeERP.Domain.Product.Models.ProductCollection");
            ...
            modelBuilder.Entity("HomeERP.Domain.Product.Models.ProductInCollection", b =>
                {
                    b.HasOne("HomeERP.Domain.Product.Models.ProductCollection", "ProductCollection")
                        .WithMany("Products")
                        .HasForeignKey("ProductCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomeERP.Domain.EAV.Models.Object", "Product")
                        .WithMany()
